      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className="grid lg:grid-cols-3 gap-8 bg-white/5 backdrop-blur-sm rounded-2xl p-8 lg:p-12">
            ...
            <div className="col-span-2 text-justify text-white/90 font-open-sans text-lg leading-relaxed">
          ...
          <div className="grid lg:grid-cols-3 gap-8 bg-white/5 backdrop-blur-sm rounded-2xl p-8 lg:p-12">
            ...
            <div className="col-span-2 lg:order-1 text-justify text-white/90 font-open-sans text-lg leading-relaxed">
              <h3 className="text-3xl font-playfair font-bold text-white mb-4">
                Gilberto Santa Rita Tamés
              </h3>
              <div className="w-16 h-1 bg-primary mb-6"></div>
              ...
              <ul className="list-disc list-inside space-y-2 w-full text-justify">
